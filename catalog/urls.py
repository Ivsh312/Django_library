...
urlpatterns = [
    ...
    re_path(r'^borrowd/$', views.BorrowedBooksByUserListView.as_view(), name='borrowed'),
    re_path(r'^book/(?P<book_id>[-\w]+)/renew/$', views.renew_book_librarian, name='renew-book-librarian'),
